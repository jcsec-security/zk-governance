    ...
    GovernorGuardianVeto
{
    ...
    function proposalDeadline(
        uint256 _proposalId
    ) public view virtual override(Governor, IGovernor, GovernorPreventLateQuorum) returns (uint256) {
    ...
    function state(
        uint256 _proposalId
    ) public view virtual override(Governor, GovernorTimelockControl) returns (IGovernor.ProposalState) {
