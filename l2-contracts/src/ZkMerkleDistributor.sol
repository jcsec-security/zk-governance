...
contract ZkMerkleDistributor is EIP712, Nonces {
    ...
    bytes32 public constant ZK_CLAIM_AND_DELEGATE_TYPEHASH =
        keccak256(
    ...
    function claimAndDelegate(
        ...
        try
            TOKEN.delegateOnBehalf(msg.sender, _delegateInfo.delegatee, _delegateInfo.expiry, _delegateInfo.signature)
        {} catch (bytes memory) {}
    }
