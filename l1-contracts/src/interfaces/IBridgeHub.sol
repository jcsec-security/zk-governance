...
interface IBridgeHub is IPausable {
    ...
    /// @param _message Information about the sent message: sender address, the message itself, tx index in the L2 batch
    /// where the message was sent @param _proof Merkle proof for inclusion of L2 log that was sent with the message
